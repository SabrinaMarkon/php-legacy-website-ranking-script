...
#############################
$freeq = "insert into members (userid,password,firstname,lastname,country,email,signupdate,signupip,referid) values (\"$userid\",\"$password\",\"$firstname\",\"$lastname\",\"$country\",\"$email\",NOW(),\"$signupip\",\"$referid\")";
